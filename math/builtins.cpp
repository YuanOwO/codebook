 ...
 * i.e. the number of bits following the most significant
 * bit that are identical to it. There are no special
 ...
 */
int parity(ull x) { return popcount(x) & 1; }
...
/**
 * Returns x with the order of the bytes reversed; for
 * example, 0xaabb becomes 0xbbaa. Byte here always means
 * exactly 8 bits.
 */
...
/**
 * This is a helper function for the sort routines and for
 * random.tcc. Precondition: __n > 0.
 *
